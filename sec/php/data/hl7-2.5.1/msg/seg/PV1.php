...
//
/**
 * Patient Visit v2.5.1
 * @author Warren Hornsby
 */
class PV1 extends HL7SequencedSegment {
  //
  public $segId = 'PV1';
...
class PV1_ADT extends PV1 {
  ...
  static function from($fs) {
    $me = static::asEmpty();
    $me->visitNo = CX::asVisitNumber($fs);
    $me->dischargeDisp = $fs->getDataCode('dischargeDisposition');
    $me->admitDateTime = TS::fromDate($fs->Session->dateCreated); 
    return $me;
  }
}