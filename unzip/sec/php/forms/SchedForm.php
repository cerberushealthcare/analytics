...
class SchedForm extends Form {
  ...
  private function setFormProps($userId = null) {
    ...
    if ($docUserId && ! isset($this->docs[$docUserId]))
      $docUserId = null;
    if ($docUserId == null) 
  ...
  private function buildRows() {
    ...
    $slotCt = 0;
    $end = ($slotEnd > $this->page->profile->slotStart) ? $slotEnd : $slotEnd + 2400;
    for ($hh = $this->page->profile->slotStart; $hh < $end; $hh += 100) {
      $h = ($hh > 2400) ? $hh - 2400 : $hh;
