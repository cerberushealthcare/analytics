  ...
  */
  ...
  asSelector:function() {
    ...
    if (this.isClosed())
      ...
      a.setClass(AnchorClient.getClass(this.ClientStub));
  ...
  ajax:function(worker) {
    ...
    return {
      //
      fetch:function(mtid, forUserId, callback) {
        Ajax.getr(Ajax.SVR_MSG, 'getThread', {'id':mtid,'for':forUserId}, MsgThread, worker, callback);
      }
    }
  }
})
