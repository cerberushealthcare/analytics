...
?>
<div id="pop-q" class="pop" unselectable="on" style="left:0;top:0" onmousedown="event.cancelBubble = true">
  ...
  <div class="pop-content" style="padding:5px">
    <div id="pop-q-clear" class="pop-cmd pop-cmd-fs" style="display:none">
      ...
      <span>&nbsp;</span>
      <a class="cmd none"href="javascript:" onclick='Pop.close(); return false'>Cancel</a>
    </div>
    <div id="pop-cbo-p1">
      ...
      <div id="pop-q-sing">
        <div id="pop-q-sing-opts" class="options">
          <table border="0" cellpadding="0" cellspacing="0" class=bxcm> 
    ...
    <div id="pop-cbo-p2">
      <div id="pop-q-mult" style="display:none">
        ...
        <div id="pop-q-mult-opts" class="multi">
          <div id='pop-q-mult-scrolling' class='scrolling'>
            <table border="0" cellpadding="0" cellspacing="0">
              <tbody id="pop-q-mult-tbody" onclick="quiMultiClick()">
              </tbody>
            </table>
...
<div id="pop-q-calc" class="pop" onmousedown="event.cancelBubble = true">
  <div id="pop-q-calc-cap" class="pop-cap" unselectable="on">  
    ...
    <a href="javascript:qcCancel()" class="pop-close"></a>
  </div>
  <div class="pop-content" style="width:230px;padding:5px;text-align:center;" onkeydown="qcKey(); return false">
    ...
    <div class="pop-cmd">
      ...
      <span>&nbsp;</span>      
      <a class="cmd none" href="javascript:qcCancel()">Cancel</a>
    </div>
  </div>
</div>
  ...
  <div id="pop-content" class="pop-content" style="padding:5px;">
    ...
    <div id="popCal">
      ...
      <div style="background:black;padding:10px;border:1px solid #c0c0c0;">
        <table class="styleBody" style="margin:0 auto;border:1px solid #517973" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="center"><table border="0" cellpadding="3" class="styleBody" style="border-spacing:1px;border-collapse:separate" id="tblCal" onmouseover="monMouseOver()" onmouseout="monMouseOut()" onclick="calOnClick()">
              <tr>
                <td colspan="7"></td>
              </tr>
              <tr>
...
?>
<div id="popMed" class="pop" style="width:488px">
  ...
  <div class="pop-content p5">
    <div id="popM" class="med">
      ...
      <div id="popM2">
        ...
        <table border=0 cellpadding=0 cellspacing=0>
          ...
          <tr>
            ...
            <td></td>
            <td><input id="medLength" type="text" size="15" onfocus="medShow(4)"></td>
            <td></td>
            <td><input style='display:none' id="medDisp" type="text" size="15" onkeydown="if(event.keyCode==9){_$('medName').setFocus()}" onfocus="onfocusMedDisp()"></td>
          </tr>
        </table>
      </div>
      ...
      <div id="m2" style="display:none">
        ...
        <div class="medOptions">
          <ul class="medbreak">
            <li><a href="javascript:" onclick="upMedFreq(this); return false">every hour</a></li>
      ...
      <div id="m3" style="display:none">
        ...
        <div class="medOptions">
          <ul class="medbreak">
            ...
            <li><a class="big" href="javascript:" onclick="upMedRoute(this); return false">sublingually</a></li>
          </ul>
        </div>
      </div>
