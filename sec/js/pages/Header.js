...
Header.Mail = {
  ...
  setUnread:function(ct) {
    if (ct == 0) 
     // ****** crs 6/29/2016  _$('a-mail').setText('Msg').setClass('mail');
     null;
    else 
    // ****** crs 6/29/2016  _$('a-mail').setText(ct + ' unread').setClass('mail newmail');
    null;
  }
}
/*
...
Header.Review = {
  ...
  setunsigned:function(ct) {
    if (ct == 0) 
      // ****** crs 6/29/2016  _$('a-review').setText('Review').setClass('todo');
      null;
    else 
     // ****** crs 6/29/2016  _$('a-review').setText('Review ' + ct).setClass('todo red');
     null;
  }
}
Header.Labs = {
  ...
  setCount:function(ct) {
    if (ct == 0) 
      // ****** crs 6/29/2016 _$('a-labs').setText('Labs').setClass('labs').show();
      null;
    else 
     // ****** crs 6/29/2016  _$('a-labs').setText('Labs ' + ct).setClass('labs red').show();
     null;
  }
}
/*
