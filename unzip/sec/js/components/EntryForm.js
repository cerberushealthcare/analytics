...
function EntryForm(ul, firstLabelClass) {
  ...
  this.appender = {
    ...
    start:function(id){return this.startSpan(id)},
    end:function(){return this.endSpan()},
    append:function(e, id){return this.ef.append(e, null, null, id)},
    line:function(cls){return this.ef.line(cls)},
    /* labels */
    l:function(text, cls){return this.ef.appendLabel(text || '', cls)},
    ln:function(text) {return this.ef.appendLabel(text || '', 'nopad')},
    lr:function(text) {return this.ef.appendLabel('*', 'required')},
    lh2:function(text) {return this.h2(null, text)},
    lh3:function(text) {return this.h3(null, text)},
    span:function(text, cls){return this.ef.appendSpan(text, cls)},
    readonly:function(text){return this.ef.appendSpan(text, 'rof')},
    lro:function(html){return this.ef.appendSpanHtml(html, 'rof')},
    /* fields */
    ui:function(fid, p, onset){return this.ef.appendAugmented(p, fid, onset)},
    textbox:function(fid, size, maxlen){return this.ef.appendTextbox(fid, size, null, null, maxlen)},
    select:function(fid, list, blankText, onchange, unsorted){return this.ef.appendSelect(fid, list, blankText, null, null, onchange, unsorted)},
    ...
    pick:function(fid, recFid, picker, onset){return this.ef.appendRecordPicker(picker, fid, recFid, onset)},
    client:function(fid, recFid, defaultText, onset){return this.ef.appendClientPicker(fid, defaultText, recFid, null, null, onset)},
    ...
    atabf:function(fid, at, width, onchange, onpop){return this.ef.appendAnchorTab(fid, at.create(), null, null, width || 400, onchange, onpop)},
    ...
    h2:function(fid, blankText){return this.ef.appendH2(fid, blankText)},  /* fid may be null */
    h3:function(fid, blankText){return this.ef.appendH3(fid, blankText)},  /* fid may be null */
    //
    lbl:function(text, cls){return this.ef.appendLabel(text || '', cls)},
    lbln:function(text){return this.lbln(text)},
...
EntryForm.prototype = {
  ...
  cont:function() {  /*e.g. continue same line*/
    return this.appender;
  },
   ...
   */
  append:function(e, labelText, labelClass, id) {
    this.appendLabel(labelText, labelClass);
  ...
  appendSpanHtml:function(html, className) {
    if (String.isBlank(html))
      html = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    this.append(Html.Span.create(className).html(html));
    return this.appender;
  },
  /*
   ...
   */
  appendSelect:function(fid, list, blankText, labelText, labelClass, onchange, unsorted) {
    this.appendLabel(labelText, labelClass);
  ...
  appendAnchorTab:function(fid, at, labelText, labelClass, maxWidth, onchange, onpop) {
    ...
    this.appendLabel(labelText, labelClass);
    if (maxWidth) {
      var span = Html.Span.create('fwidth').setWidth(maxWidth).add(at.anchor);
  ...
  focus:function(fid) {
    var e = (String.is(fid)) ? this.fields[fid] : this.getFirstFocusable();
    if (e)  
      Page.focus(e);
  },
  ...
  $:function(i) {  // fid or id
    return this.getField(i) || this[i];
  },
  /*
  ...
  _cacheAndAppend:function(fid, e, eAppend) {  // eAppend required only if different than e, e.g. a <span> surrounding <e> 
    if (e) {
      ...
      e = Object.clone(EntryForm._HIDDEN_ELEMENT);
    }
    if (this._firstFocusable == null && e.setFocus)
      this._firstFocusable = e;
    this.fields[fid] = e;
    this._e = e;
  },
