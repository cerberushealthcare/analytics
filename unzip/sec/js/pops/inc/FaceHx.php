          ...
          <tr>
            <td>
              <div class="pop-cmd cmd-right">
                <span id='medhx-act'>
                <a href="javascript:" onclick="javascript:FaceHx.fpAddMedHx()" class="cmd new">Add By Quick List...</a>
                <span>&nbsp;</span>
                <a href="javascript:" onclick="javascript:FaceHx.fpLookupMedHx()" class="cmd new">Add By Lookup...</a>
                <span>&nbsp;</span>
                </span>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td>
              <div class="pop-cmd cmd-right">
                <span id='surghx-act'>
                <a href="javascript:" onclick="javascript:FaceHx.fpAddSurgHx()" class="cmd new">Add By Quick List...</a>
                <span>&nbsp;</span>
                <a href="javascript:" onclick="javascript:FaceHx.fpLookupSurgHx()" class="cmd new">Add By Lookup...</a>
                <span>&nbsp;</span>
                </span>
                <a href="javascript:FaceHx.fpClose()" class="cmd none">&nbsp;&nbsp;Exit&nbsp;&nbsp;</a>
              </div>
          ...
          <tr>
            ...
            <td style="width:100%">
              <div class="pop-cmd cmd-right">
                ...
                <span>&nbsp;</span>
                <a href="javascript:" onclick="javascript:FaceHx.fpAdopted()" class="cmd none">"Adopted"</a>
                <a href="javascript:" onclick="javascript:FaceHx.fpUnknown()" class="cmd none">"Unknown"</a>
                <a href="javascript:" onclick="javascript:FaceHx.fpFamClear()" class="cmd none">Clear</a>
                <span>&nbsp;</span>
                </span>
                <span>&nbsp;</span>
                <a href="javascript:FaceHx.fpClose()" class="cmd none">&nbsp;&nbsp;Exit&nbsp;&nbsp;</a>
