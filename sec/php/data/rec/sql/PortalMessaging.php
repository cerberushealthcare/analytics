...
class PortalMessaging {
  ...
  static function getMyMsgTypes() {
    ...
    return PortalMsgType::fetchList($sess->userGroupId, $default->userId);
  }
  //
...
/**
 * @todo Doesn't this need to be user level like PortalMsgType_A in PortalUsers.php?
 */
class PortalMsgType extends SqlGroupLevelRec implements ReadOnly, NoAudit {
  //
  public $msgTypeId;
  public $userGroupId;
  public $name;
...
class MsgPost_Portal extends MsgPost implements NoAudit {
  ...
  public function attachStub() {
    if ($this->stubType && $this->stubId) {
      ...
      $this->Stub = DocStub_Preview::fetch($stub, null);
    }
  }
}
/**
