...
class ParForm extends Form {
  ...
  public $dataTables = array();
	...
	public function buildPar() {
		return new Par($this->id, $this->sectionId, $this->uid, $this->major, $this->sortOrder, $this->desc, $this->noBreak, $this->injectOnly, null, $this->inTable, $this->inType, $this->inCond, $this->dev);
	}
	...
	public function setFromPost() {
		...
		$this->dev = $this->toBool(isset($_POST["dev"]) ? $_POST["dev"] : null);
	}
