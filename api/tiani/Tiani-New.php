...
//put your code here
    ...
    public function retrievePatientDocumentList($patient, $provider){
       ...
       * TESTING!!!!!!!!!!
       */
      $j = '[{"authorInstitution":"US XDS Domain","authorPerson":"Physicianette Two","classCode":{"nodeRepresentation":"Consent","schema":"Connect-a-thon classCodes","value":"Consent"},"confidentialityCode":{"nodeRepresentation":"C","schema":"Connect-a-thon confidentialityCodes","value":"Celebrity"},"creationTime":"20110204132504","docHandlingType":0,"docStatus":"urn:oasis:names:tc:ebxml-regrep:StatusType:Approved","ehrDocStatus":1,"ehrDocType":6,"formatCode":{"nodeRepresentation":"PDF\/IHE 1.x","schema":"Connect-a-thon formatCodes","value":"PDF\/IHE 1.x"},"hash":"bc6fea6702364b9ef09fc736c57bdd412c764064","healthcareFacilityCode":{"nodeRepresentation":"C","schema":"Connect-a-thon confidentialityCodes","value":"Celebrity"},"homeCommunityId":"","languageCode":"EN-US","loaderUri":"LoaderServlet?Act=loadDoc&docUri=&repUid=2.16.17.710.900.1000.990.1&homeComId=&uniqueId=1.2.40.0.13.1.1.10.10.20.101.20110204090310314.33081&mimeType=application%2Fpdf&selfXca=false&xdsPatId=29^^^%262.16.17.710.900.1000.990.1%26ISO&usedXdsCons=WorkAroundXdsConsumer -> Spirit Registry (Xds.b, nonSecure)","mimeType":"application\/pdf","name":"Referral Document","patientId":"29^^^&2.16.17.710.900.1000.990.1&ISO","practiceSettingCode":{"nodeRepresentation":"Endocrinology","schema":"Connect-a-thon practiceSettingCodes","value":"Endocrinology"},"repositoryUniqueId":"2.16.17.710.900.1000.990.1","selfXca":false,"serviceStartTime":"20110204132504","serviceStopTime":"20110204132504","size":4989,"sourceRecordTargetId":"29^^^&2.16.17.710.900.1000.990.1&ISO","sourceRecordTargetInfo":["PID-3|29^^^&2.16.17.710.900.1000.990.1&ISO","PID-5|SAMPLE^SAM","PID-7|20110204"],"typeCode":{"nodeRepresentation":"34140-4","schema":"LOINC","value":"Notes"},"UUID":"urn:uuid:44346bce-7fa5-4349-a341-da757ffff943","uniqueId":"1.2.40.0.13.1.1.10.10.20.101.20110204090310314.33081","uri":"","usedXdsCons":"WorkAroundXdsConsumer -> Spirit Registry (Xds.b, nonSecure)"}]';
      return jsondecode($j);
...
//Need to define metadata from clicktate
        ...
        foreach ($uploadResponse as $ur) {
            ...
            $params->arg0->srcSubmission->documents[$counter]->classCode->nodeRepresentation = "Consent";
            $params->arg0->srcSubmission->documents[$counter]->classCode->schema = "Connect-a-thon classCodes";
            $params->arg0->srcSubmission->documents[$counter]->classCode->value = "Consent";
            $params->arg0->srcSubmission->documents[$counter]->confidentialityCode->nodeRepresentation = "C";

            $params->arg0->srcSubmission->documents[$counter]->confidentialityCode->schema = "Connect-a-thon confidentialityCodes";
            $params->arg0->srcSubmission->documents[$counter]->confidentialityCode->value = "Celebrity";
            ...
            $params->arg0->srcSubmission->documents[$counter]->typeCode->nodeRepresentation = "34140-4";
            $params->arg0->srcSubmission->documents[$counter]->typeCode->schema = "LOINC";
            $params->arg0->srcSubmission->documents[$counter]->typeCode->value = "Notes";
            ...
            if ($mimeType == "application/pdf") {
                ...
                $params->arg0->srcSubmission->documents[$counter]->formatCode->nodeRepresentation = "CCR V1.0";
                $params->arg0->srcSubmission->documents[$counter]->formatCode->value = "CCR V1.0";
                $params->arg0->srcSubmission->documents[$counter]->formatCode->schema = "Connect-a-thon formatCodes";
                $params->arg0->srcSubmission->documents[$counter]->description = "CCR/CCD";
                $params->arg0->srcSubmission->documents[$counter]->name = "CCR Document";
            }
            $counter++;
        }
