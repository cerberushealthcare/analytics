...
class CE_HL7_AdministrativeGender extends CE_CodeSystem {
  ...
  public /*st*/ $_codeSystemName = 'AdministrativeGender';
  //
...
class CE_HL7_ActCode extends CE_CodeSystem {
  ...
  public /*st*/ $_codeSystemName = 'ActCode';
  //
