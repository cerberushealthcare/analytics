      ...
      return {
        ...
        init:function() {
          self.tiles = Html.Tiles.create(self, [
            ...
            self.login = AnchorPortalUser.create_withClientName()
    ...
    return Html.DirtyEntryPop.create('Portal User Activation', 600).extend(function(self) {
      return {
        ...
        init:function() {
          ...
          self.cb = Html.Pop.CmdBar.create(self)
        ...
        refused_onclick:function() {
          Pop.Confirm.showYesNo('Are you sure you want to record patient refused portal access?', function() {
            self.close();
            Ajax.PortalAccounts.refuse(self.rec.clientId, function() {
              self.close();
            });
          })          
        }
