...
class TrackItem extends SqlRec {
  ...
  //
  const TID_ORDERING = '30';  // Ordering template
  //
  ...
  public static function getConstants() {
    $rc = new ReflectionClass('TrackItem');
  ...
  public static function sort(&$recs) {
    Rec::sort($recs, new RecSort('trackCat', 'closedDate', '-priority', 'schedDate', 'orderDate', 'trackDesc'));
  }
}
