      ...
      <div id="logo-head" <?=$popstyle?>>
        <div style='background:#D2E3E0;'>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><a class='logo' href="welcome.php"><img src="img/lhdLogoTop2.png" <?if ($login->cerberus || $baiju) {?>style="visibility:hidden" <?}?>/></a></td>
              <td class="logo-right">
        ...
        <div id='top'>
          ...
          <div<?if ($login->cerberus || $baiju) {?> class='edge2'<?}?>>
            <table id='logo-bot' border=0 cellpadding=0 cellspacing=0>
              <tr>
                <?php if ($login->cerberus || $baiju) { ?>
                  <td></td>
                <?php } else { ?>
                  <td class="logoBottom">
