...
abstract class SqlRec extends Rec {
  ...
  */
  ...
  static function fetch() {
    ...
    if (empty($values))
      throw new SqlRecException($rec, 'No fetch args supplied. Trace is ' . getStackTrace());
