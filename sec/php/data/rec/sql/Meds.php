...
class Meds {
  ...
  static function rebuildFromSessions($cid) {
    $args = func_get_args();
    return call_user_func_array(self::getDaoMethod(__FUNCTION__), $args);
  }
  /**
   ...
   */
  static function rebuildFromNewCrop($cid, $current, $withAudits, $noinsurance) {
    $args = func_get_args();
    return call_user_func_array(self::getDaoMethod(__FUNCTION__), $args);
  }
  /**
  ...
  static function getAll($cid, $actives = null) {
    $class = self::getDao();
    return $class::getAll($cid, $actives);
  }
  /**
  ...
  private static function getDao() {
    global $login;
    return self::getDaoClass($login->isErx());
  }
  private static function getDaoMethod($method) {
    global $login;
    return array(self::getDaoClass($login->isErx()), $method);
  }
}
class NoneActiveMed extends FaceMedNc {
  //
