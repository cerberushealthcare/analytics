...
class ChartIndex {
  ...
  static $CHARTS = array(
     ...
     * WHO/CDC charts
     */
    'lfa-girls-0t2y-whcd' => array(
      'dim' => array(98, 123, 511, 545),
      'y' => array(35, 103, 'Length (cm)'),
      'x' => array(0, 24, 'Age (mos)')),
    'wfa-girls-0t2y-whcd' => array(
      'dim' => array(98, 123, 511, 864),
      'y' => array(1, 22.6, 'Weight (kgs)'),
      'x' => array(0, 24, 'Age (mos)')),
    'lfa-boys-0t2y-whcd' => array(
      'dim' => array(99, 123, 511, 545),
      'y' => array(35, 103, 'Length (cm)'),
      'x' => array(0, 24, 'Age (mos)')),
    'wfa-boys-0t2y-whcd' => array(
      'dim' => array(98, 123, 511, 864),
      'y' => array(1, 22.7, 'Weight (kgs)'),
      'x' => array(0, 24, 'Age (mos)')),
    'hcfa-boys-0t2y-whcd' => array(
      'dim' => array(112, 113, 511, 484),
      'y' => array(29, 54, 'Head (cm)'),
      'x' => array(0, 24, 'Age (mos)')),
    'wfl-boys-0t2y-whcd' => array(
      'dim' => array(112, 113, 511, 800),
      'y' => array(0, 34.44, 'Weight (kgs)'),
      'x' => array(45, 110.5, 'Length (cm)')),
    'hcfa-girls-0t2y-whcd' => array(
      'dim' => array(112, 113, 511, 484),
      'y' => array(29, 54, 'Head (cm)'),
      'x' => array(0, 24, 'Age (mos)')),
    'wfl-girls-0t2y-whcd' => array(
      'dim' => array(112, 113, 511, 800),
      'y' => array(0, 34.44, 'Weight (kgs)'),
      'x' => array(45, 110.5, 'Length (cm)')),
  	/*
  ...
  private static function getChartType($id) {
    ...
    if (strpos($id, '-whcd') !== false)
      return self::TYPE_GROWTH_WHOCDC;
