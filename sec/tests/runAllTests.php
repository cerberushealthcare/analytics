	...
	<head>
		...
		<script type="text/javascript">
			var files = [		'LoginSession_login.php',
								...
								'unit/AssocArrayClass_QueryReturnsCorrectResult.php',
								...
								'unit/loginSession_fetchUserWithLogging_ReadCorrectData.php',
								'unit/Dao_query_returnsIntegerFromInsertQuery.php',
								'unit/MsgInbox_countUnread_IsNotEmpty.php',
								'unit/apiLogin_ReturnsNoErrors.php',
								/*'../tester.php?t=1',
								'../tester.php?t=2',
								'../tester.php?t=3',
