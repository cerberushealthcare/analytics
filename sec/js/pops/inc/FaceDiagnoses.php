                ...
                <table id="fsp-dia-tbl" class="fsy single">
                  <thead>
                    <tr id="fsp-dia-head" class="fixed head">
                      ...
                      <th style='width:17%'>Effective</th>
                      <th style='width:17%'>Reconciled</th>
                    </tr>
                  </thead>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:5px">
                <tr>
                  <td nowrap="nowrap" style="padding-left:10px">
                    <div class="pop-cmd">
                      <a id='dia-recon' class='cmd clipboard' href='javascript:FaceDiagnoses.fpReconcile()'>Reconcile With...</a>
                    </div>
                  </td>
                  <td style="width:100%">
