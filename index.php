    ...
    <table cellpadding="0" cellspacing="0">
      <tr>
        <td id="belt-left">
          ...
          <div id="tag2">
            <p>
              Clicktate is a revolutionary EMR and documentation system that is unlike anything you've ever seen. (1)
            </p>
          </div>
          <table cellpadding="0" cellspacing="0">
            <tr>
...
<div id="leg">
  <div class="content">
    <table cellpadding="0" cellspacing="0">
      <tr>
        <td>
          <h3>CERTIFIED FOR MEANINGFUL USE</h3>
          <p>
            <b>Clicktate 4.0</b> meets all requirements necessary for Meaningful Use and has been <a href="http://oncchpl.force.com/ehrcert/EHRProductDetail?id=a0A3000000LW3tlEAD&retURL=%2Fehrcert%2FEHRProductSearch&setting=Ambulatory">certified as a Complete EHR</a> for ambulatory practices.
            Providers using Clicktate 4.0 to achieve meaningful use are eligible to receive Medicare EHR incentive payments.
            Features include:
          </p>
          <table cellpadding="0" cellspacing="0">
            <tr>
              <td style='width:50%;vertical-align:top'>
                <ul class='homelist'>
                  ...
                  <li>Lab interfaces</li>
                  <li>Patient education</li>
                  <li>Reporting and report building</li>
                  <li>Scheduling</li>
                </ul>
              </td>
              <td style='width:50%;vertical-align:top'>
                <ul class='homelist' style='margin-left:10px;padding-left:0'>
                  <li>Document imaging and scanning</li>
                  <li>Order entry and tracking</li>
                  <li>Messaging</li>
                  <li>Cross-browser support</i>
                  <li>Comprehensive documentation<br>library</li>
                </ul>
              </td>
            </tr>
          </table>
          <p>
            If you are a current user and would like to transition to the certified system, please <a href="mailto:jdavis@cerberushealthcare.com">contact us</a> for more information.
          </p>
        </td>
        <td style="width:235px; text-align:center;">
          <div><a href="http://oncchpl.force.com/ehrcert/EHRProductDetail?id=a0A3000000LW3tlEAD&retURL=%2Fehrcert%2FEHRProductSearch&setting=Ambulatory"><img src='img/SLI_Seal_CompleteEHR_40.jpg' /></a></div>
          <div><a href="http://www.surescripts.com/connect-to-surescripts/prescriber-software/search.aspx?VPKeyword=clicktate"><img src='img/surescripts-certified.png' /></a></div><div style='padding-top:2px;text-align:center;font-size:7pt;font-family:Arial'>VIA NEWCROP</div>
        </td>
      </tr>
    </table>
    <table cellpadding="0" cellspacing="0" style="margin-top:5px">
      <tr>
        <td>
          <h3>COMPLETE PRACTICE MANAGEMENT SOLUTION</h3>
          <p>
            Through a partnership with Cerberus Healthcare we are pleased to offer Papyrus, a complete practice management suite
            that combines Clicktate 4.0 with more robust scheduling, office/patient flow tracking, billing services, and electronic claims clearinghouse integration.
            Please <a href="mailto:info.clicktate.com">contact us</a> for more information.
          </p>
        </td>
        <td style="width:235px; text-align:center;">
          <img src='img/papyrus3.png' />
        </td>
      </tr>
    </table>
    <table cellpadding="0" cellspacing="0" style="margin-top:10px">
      <tr>
        ...
        <td id="col2">
          ...
          <p>
            All Clicktate sessions use SSL encryption
