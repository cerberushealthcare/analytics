    ...
    <div id="csf" class="scrollform">
      <div class="sfcontent">
        ...
        <ul class="entry">
          ...
          <li>
            <label id="po-lbl-dnr" class="first4"></label>
            <span id="po-dnr" class="ro" style="width:330px"></span>            
            <a class="pencil smar" href="javascript:" onclick="PatientEditor.pe2Edit(15)">Edit</a>
          </li>
          <li>
            <label id="po-lbl-immreg" class="first4"></label>
            <span id="po-immreg" class="ro" style="width:330px"></span>            
            <a class="pencil smar" href="javascript:" onclick="PatientEditor.pe2Edit(16)">Edit</a>
          </li>
        </ul>
        <h1 id="csf-family" style="margin-top:10px">Family</h1>
        <ul class="entry">
          <li>
            <label id="po-lbl-father" class="first4">Father</label>
          ...
          <li>
            <label id="po-lbl-mother" class="first4">Mother</label>
      ...
      <div class="pop-frame-content">
        <ul class="entry">
          ...
          <li style="margin-bottom:8px">
            <label class='first'>County</label>
            <input id="pa-county" type="text" size="25" value="" />
          </li>
        </ul>
  ...
  <div class="pop-content">
    <div class="pop-frame">
      <div class="pop-frame-content">
        <ul class="entry">
          <li>
            <label id='pcu-clabel1' class="first">Custom 1</label>
