...
var FaceUi = {
  ...
  createSessionAnchor:function(fs, id, asZoom, source) {
    if (id == 0) {
      ...
      var stub = fs.docstubs.get_session(id);
      return AnchorDocStub_Preview.create(stub);
      ...
      if (sess) {
        ...
        return Html.Span.create('perfs', 'Note Not Found');
      }
      */
    }
  },
  ...
  qSingle:function(q) {
    ...
    return FaceUi.single(q.Opts.getTexts());
  },
  _makeMap:function(a) {
    var aa = {};
