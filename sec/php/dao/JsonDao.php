...
//        }
  ...
  public static function getQidFromQref($tid, $noteDate, $suid, $puid, $quid) {  // returns questionId if valid, null if invalid
    $sql = "SELECT q.question_id FROM template_sections s INNER JOIN template_pars p ON s.section_id=p.section_id INNER JOIN template_questions q ON q.par_id=p.par_id WHERE s.template_id="
