...
//Update
            ...
            if (is_array(get($demoOnlyRes->return, 'responseData')))
...
//Iterate
    ...
    private function patientExists($patResp) {
        ...
        if (get($patResp->return, 'responseData') != null)
            return true;
        else
            return false;
    }
...
//Single docs and folders at level, non-arrays
    ...
    private function documentIdentify($d, &$returnval) {
        if ($d instanceOf stdClass && $d->loaderUri != null && get($d, 'childDocuments') == null) {
            //echo("Here");
