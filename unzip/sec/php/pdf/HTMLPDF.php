...
class HTMLPDF extends TCPDF {
  ...
  public function __construct($font = 'times') {
    ...
    $this->setHeaderFont(array($font, '', 9));
   ...
   */
  public function outputAsDownload($filename = null) {
    if (empty($filename))
  ...
  //
  static function asHelvetica($title) {
    $me = new static('helvetica');
    $me->setDocInfo(null, $title);
    return $me;
  }
}
